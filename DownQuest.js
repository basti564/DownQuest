...
function showModal(titleString, customContent, closeable = true) {
    ...
    backdrop.classList.add("x1ey2m1c", "xds687c", "xixxii4", "x17qophe", "x13vifvy", "x1t853zo", "xa3vuyk", "x6o7n8i", "x1hc1fzr", "xeg22mp");//sky-modal__backdrop
    if (closeable) {
    ...
    modal1.classList.add("x1ey2m1c", "x78zum5", "xdt5ytf", "xl56j7k", "xgqtt45", "xixxii4", "x3m8u43", "x13vifvy", "x1hc1fzr");//sky-modal
    ...
    modal3.classList.add("xgwl07f", "x1lq5wgf", "xgqcy7u", "x30kzoy", "x9jhf4c", "x1j8fuow", "x78zum5", "xdt5ytf", "xhd83ik", "x10rn61k", "xpt360o", "xmnoj47", "xyp16gn");
    modal2.appendChild(modal3);

    const modal4 = document.createElement("div");
    modal4.classList.add("xb57i2i", "x1q594ok", "x5lxg6s", "x78zum5", "xdt5ytf", "x6ikm8r", "x1ja2u2z", "x1pq812k", "x1rohswg", "x1yqm8si", "xjx87ck", "xx8ngbg", "xwo3gff", "x1oyok0e", "x1odjw0f", "x1e4zzel", "x1iyjqo2", "xdl72j9", "x1n2onr6");
    modal3.appendChild(modal4);

    const title = document.createElement("div");
    title.classList.add("xso031l", "x1q0q8m5", "x1kux67n", "x78zum5", "xl56j7k", "x21xpn4", "xyamay9", "x1pi30zi", "x1l90r2v", "x1swvt13", "x1aueamr", "x1s688f"); //sky-modal__title
    ...
    if (closeable) {
        ...
        titleClose.classList.add("x1i10hfl", "x1qjc9v5", "xjbqb8w", "xjqpnuy", "xa49m3k", "xqeqjp1", "x2hbi6w", "x13fuv20", "xu3j5b3", "x1q0q8m5", "x26u7qi", "x972fbf", "xcfux6l", "x1qhh985", "xm0m39n", "x9f619", "x1ypdohk", "xdl72j9", "xdt5ytf", "x2lah0s", "xe8uvvx", "xdj266r", "x11i5rnm", "xat24cr", "x1mh8g0r", "x2lwn1j", "xeuugli", "xexx8yu", "x4uap5", "x18d9i69", "xkhd6sd", "x16tdsg8", "xggy1nq","x1ja2u2z", "x1t137rt", "x1hl2dhg", "x1lku1pv", "x1n2onr6", "x1rg5ohu")
        title.appendChild(titleClose);

        const titleCloseIcon = document.createElement("i");
        titleCloseIcon.style = "background-image: url('https://static.xx.fbcdn.net/rsrc.php/v3/yJ/r/YKage5MIYCR.png'); background-position: -149px -159px; background-size: 228px 358px; width: 24px; height: 24px; background-repeat: no-repeat; display: inline-block;";
...
function createDropdownToggle(parent, items, selected, action) {
    ...
    toggleCaret.style = "background-image: url('https://static.xx.fbcdn.net/rsrc.php/v3/yJ/r/YKage5MIYCR.png'); background-position: -49px -159px; background-size: 228px 358px; width: 24px; height: 24px; background-repeat: no-repeat; display: inline-block;"
...
function createDropdown(dropdownToggle, items, selected, action, destroy) {
    ...
    bottom.classList.add("xu96u03", "xm80bdy", "x10l6tqk", "x13vifvy", "x1q2oy4v");
...
async function downloadBuild(binary_id, version_code, obb_id) {
    chrome.runtime.sendMessage("Me want cookie!", async (response) => {
        ...
        if (null != access_token) {
                            ...
                            .then(async function (arrayBuffer) {
                                ...
                                const customContent = async function customContent(header, versions, closeModal) {
                                    ...
                                    try {
                                        ...
                                        const totalSize = Object.values(files).reduce((total, file) => total + file.size, 0);
                                        let currentSize = 0;
                                                ...
                                                for (const segment of files[key].segments) {
                                                    ...
                                                    await response.arrayBuffer()
                                                        .then(async function (arrayBuffer) {
                                                            ...
                                                            progressIndicator.style.width = ((currentSize / totalSize * 100) + "%");
                                                        });
                                                }
                                            }
            ...
            const customContent = function (header, versions) {
                const headerText1 = document.createTextNode("No oculus.com login found, please log into ");
...
async function openURI(uri, important) {
    try {
        ...
        if (response.ok) {
            ...
            console.info("Couldn't access " + uri + " because you probably haven't purchased it");
            if (important) {
